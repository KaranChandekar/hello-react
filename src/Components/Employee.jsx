...
const Employee = (props) => {
  return (
    <div className="min-w-[350px] max-w-[350px] py-8 px-8 max-w-sm m-4 bg-white rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
      <img
